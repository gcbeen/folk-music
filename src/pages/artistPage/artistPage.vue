<template>
  ...
  <view class="artist-page">
    ...
    <view class="name-card-box">
      ...
      <view
        style="text-align: center; padding-bottom: 20rpx"
        v-if="detail.artist.rank"
      >
        <u-count-to
          :start-val="10"
          :duration="4000"
          :end-val="detail.artist.rank.rank"
        ></u-count-to>
        <view>
    ...
    <!-- introduction 更全的介绍 -->
    <view
      class="intro-card-box"
      v-for="item in desc.introduction"
      :key="item.ti"
    >
      <view class="text-card-title">
        <u-divider fontSize="38" height="100" color="#000">{{
          item.ti
        }}</u-divider>
      </view>
      <view class="intro-card-content">
